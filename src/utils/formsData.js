export const addUserFormData=(committees)=>[
  ...
  {label:"committee",options:committees?committees.map((committee)=>{return {name:committee.Title,value:committee.Id}}):[]
,inputType:'dropdown',
  }
...
export const addWorkshopFormData=(committees,users)=>{return [
  ...
  {label:'duration in sessions' ,placeholder:'enter duration in sessions'},
  ...
  {label:'state' ,options:["not-started",'in-progress','finished'],inputType:'dropdown'},
  {label:'prerequisites' ,placeholder:'enter prerequisites each seperated by a comma'},
  {label:'season' ,placeholder:'enter season'},
]}
