...
let candidateTrack;
const normalCards=Object.keys(candidate).map((field)=>{
  let result;
...
case 'secondpreference':
  {
    result={
      cardTitle:field==='FirstPreference'?"first preference":'second preference',
...
case 'college':
  {
    candidateInfo[field.toLowerCase()==='academicyear'?'year':field.toLowerCase()]=candidate[field]
    break;
  }
