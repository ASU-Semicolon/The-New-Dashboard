...
return state
    ...
    editWorkshop:(state,action)=>{
      const workshopIndex=state.findIndex((workshop)=>action.payload.id===workshop.Id)
...
export const {editWorkshop,deleteWorkshop,addWorkshop,loadWorkshops}=workshopsSlice.actions